...
$(function() {
    ...
    $('#btnMoreMatchs').on('click', function() { window.location.href = 'matchs.html?name=' + GETname })
...
async function viewsInfoAccount(data) {
    ...
    const lastLoginTime = (data.globals.lastLoginTime).slice(11,16) + ' ' + (data.globals.lastLoginTime).slice(8,10) + '/' + (data.globals.lastLoginTime).slice(5,7) + '/' + (data.globals.lastLoginTime).slice(0,4);
    const lastLogoutTime = (data.globals.lastLogoutTime).slice(11,16) + ' ' + (data.globals.lastLogoutTime).slice(8,10) + '/' + (data.globals.lastLoginTime).slice(5,7) + '/' + (data.globals.lastLoginTime).slice(0,4);
    $("#lastLoginTime").text(lastLoginTime);
    $("#lastLogoutTime").text(lastLogoutTime);
        ...
        if (data[i]) {
            ...
            if (data[i].mode == '1v1') {
                ...
                dataGames += '<td style="width:5em;"></td>'+
                            '<td style="width:5em;"><a class="btn m-0 p-0" data-bs-toggle="tooltip" data-bs-placement="bottom" title="'+data[i].me.username+'" href="account.html?name='+data[i].me.username+'"><img style="max-height:5em; width:auto;" src="/img/perso/' + data[i].me.character + '.jpg"></a><p class="text-light p-0 m-0">'+notIsNaN(Math.round(data[i].me.preMmr*100)/100)+'</p> '+formateMmrDiff(mmrDiffMe)+'</td>' +
                            '<td>VS</td>' +
                            '<td style="width:5em;"><a class="btn m-0 p-0" data-bs-toggle="tooltip" data-bs-placement="bottom" title="'+data[i].enemy.username+'" href="account.html?name='+data[i].enemy.username+'"><img style="max-height:5em; width:auto;" src="/img/perso/' + data[i].enemy.character + '.jpg"></a><p class="text-light p-0 m-0">'+notIsNaN(Math.round(data[i].enemy.preMmr*100)/100)+'</p> '+formateMmrDiff(mmrDiffEnemy)+'</td>' +
            ...
            if (data[i].mode == '2v2') {
                ...
                dataGames += '<td style="width:5em;">'+dataDate+'</td>';
                dataGames += '<td style="width:5em;"><a class="btn m-0 p-0" data-bs-toggle="tooltip" data-bs-placement="bottom" title="'+data[i].me.username+'" href="account.html?name='+data[i].me.username+'"><img style="max-height:5em; width:auto;" src="/img/perso/' + data[i].me.character + '.jpg"></a><p class="text-light p-0 m-0">'+notIsNaN(Math.round(data[i].me.preMmr*100)/100)+' '+formateMmrDiff(mmrDiffMe)+'</p></td>' +
                                '<td style="width:5em;"><a class="btn m-0 p-0" data-bs-toggle="tooltip" data-bs-placement="bottom" title="'+data[i].ally.username+'" href="account.html?name='+data[i].ally.username+'"><img style="max-height:5em; width:auto;" src="/img/perso/' + data[i].ally.character + '.jpg"></a><p class="text-light p-0 m-0">'+notIsNaN(Math.round(data[i].ally.preMmr*100)/100)+' '+formateMmrDiff(mmrDiffAlly)+'</p></td>' +
                                '<td>VS</td>' +
                                '<td style="width:5em;"><a class="btn m-0 p-0" data-bs-toggle="tooltip" data-bs-placement="bottom" title="'+data[i].enemy.username+'" href="account.html?name='+data[i].enemy.username+'"><img style="max-height:5em; width:auto;" src="/img/perso/' + data[i].enemy.character + '.jpg"></a><p class="text-light p-0 m-0">'+notIsNaN(Math.round(data[i].enemy.preMmr*100)/100)+' '+formateMmrDiff(mmrDiffEnemy)+'</p></td>' +
                                '<td style="width:5em;"><a class="btn m-0 p-0" data-bs-toggle="tooltip" data-bs-placement="bottom" title="'+data[i].enemy2.username+'" href="account.html?name='+data[i].enemy2.username+'"><img style="max-height:5em; width:auto;" src="/img/perso/' + data[i].enemy2.character + '.jpg"></a><p class="text-light p-0 m-0">'+notIsNaN(Math.round(data[i].enemy2.preMmr*100)/100)+' '+formateMmrDiff(mmrDiffEnemy2)+'</p></td>'+
                                '<td><p class="grey json-txt-map"></p><p class="json-txt-' + data[i].mapName + '"></p></td>' +
                                '<td><p class="grey json-txt-duration"></p>' + data[i].duration + '</td>' +
                                '<td><p class="grey json-txt-me"></p>' + data[i].me.damageDone + '<p>' + data[i].me.ringOuts + ' - ' + data[i].me.deaths + '</p></td>' +
