        ...
        if (data[i] && first) {
            ...
            if (data[i].mode == "1v1") {
                ...
                dataGames +=
                    ...
                    '<td style="width:5em;"><a class="btn" data-bs-toggle="tooltip" data-bs-placement="bottom" title="' + data[i].me.username + '" href="account.html?name=' + data[i].me.username +
                ...
                dataGames +=
                    ...
                    notIsNaN(Math.round(data[i].enemy.preMmr * 100) / 100) + "</p> " +
                    formateMmrDiff(mmrDiffEnemy) +
                    "</td>" +
                    '<td style="width:5em;"></td>' +
            ...
            if (data[i].mode == "2v2") {
                ...
                dataGames +=
                    ">" +
                    '<img style="max-height:5em; width:auto;" src="/img/perso/' +
                    data[i].ally.character +
